...
public class ItemShredderContainer extends Container {
    ...
    public ItemShredderContainer(int windowId, World world, BlockPos pos,
                                 PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.ITEM_SHREDDER_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, ModBlocks.ITEM_SHREDDER.get());
    }

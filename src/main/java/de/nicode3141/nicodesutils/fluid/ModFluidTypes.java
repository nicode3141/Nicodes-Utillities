...
public class ModFluidTypes {
    ...
    public static final ResourceLocation SOAP_OVERLAY_RL = new ResourceLocation(NicodesUtils.MOD_ID, "misc/in_soap_water");
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties){
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL,SOAP_OVERLAY_RL,
                0xA1E038D0, new Vector3f(224f / 266f, 56f / 255f, 208f / 255f), properties));
    }

...
public class ElectrolysisChamberMenu extends AbstractContainerMenu {
    ...
    public ElectrolysisChamberMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.ELECTROLYSIS_CHAMBER_MENU.get(), id);
        checkContainerSize(inv,3); //Count of the SLOTS (3). MUST match TE_INVENTORY_SLOT_COUNT!!!
    ...
    public int getScaledProgress(){
        ...
        int progressArrowSize = 26; // height/lenght of pixels in the ProgressBar
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.ELECTROLYSIS_CHAMBER.get());
    }

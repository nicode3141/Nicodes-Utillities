...
public class NicodeBlockScreen extends ContainerScreen<NicodeBlockContainer> {
    private final ResourceLocation GUI = new ResourceLocation(NicodesUtils.MOD_ID,
            "textures/gui/nicode_block_gui.png");

    public NicodeBlockScreen(NicodeBlockContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {

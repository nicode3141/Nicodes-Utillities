package de.nicode3141.nicodesutils.world;
...
public class ModWorldEvents {
    ...
    public static void addDimensionalSpacing(final WorldEvent.Load event) {
        if(event.getWorld() instanceof ServerWorld) {
            ...
            tempMap.putIfAbsent(ModStructures.EXAMPLESTRUCTURE.get(),
                    DimensionStructuresSettings.field_236191_b_.get(ModStructures.EXAMPLESTRUCTURE.get()));

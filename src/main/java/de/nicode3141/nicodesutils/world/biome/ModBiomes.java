...
public class ModBiomes {
    ...
    public static final RegistryObject<Biome> BRP_BIOME = BIOMES.register("brp_biome",
            () -> makeBRPBiome(() -> ModConfiguredSurfaceBuilders.DARK_CODE,0.25f,0.05f));
    ...
    private static Biome makeBRPBiome(final Supplier<ConfiguredSurfaceBuilder<?>> surfaceBuilder,float depth,float scale) {
        MobSpawnInfo.Builder mobspawninfo$builder = new MobSpawnInfo.Builder();
        DefaultBiomeFeatures.withPassiveMobs(mobspawninfo$builder);
        DefaultBiomeFeatures.withBatsAndHostiles(mobspawninfo$builder);
        mobspawninfo$builder.withSpawner(EntityClassification.MONSTER,

package de.nicode3141.nicodesutils.world.structure;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableMap;
import de.nicode3141.nicodesutils.NicodesUtils;
import de.nicode3141.nicodesutils.world.structure.structures.examplestructureStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURES =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, NicodesUtils.MOD_ID);

    public static final RegistryObject<Structure<NoFeatureConfig>> EXAMPLESTRUCTURE =
            STRUCTURES.register("examplestructure", examplestructureStructure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(EXAMPLESTRUCTURE.get(),
                new StructureSeparationSettings(20,9, 1234567890),
                true);
    }

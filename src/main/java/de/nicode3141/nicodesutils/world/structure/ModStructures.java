...
import de.nicode3141.nicodesutils.world.structure.structures.NicodesvillaStructure;
...
public class ModStructures {
    ...
    public static final RegistryObject<Structure<NoFeatureConfig>> NICODESVILLA =
            STRUCTURES.register("nicodesvilla", NicodesvillaStructure::new);
    ...
    public static void setupStructures() {
        setupMapSpacingAndLand(NICODESVILLA.get(),

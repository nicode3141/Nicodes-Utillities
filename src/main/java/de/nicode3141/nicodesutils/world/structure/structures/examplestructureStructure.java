package de.nicode3141.nicodesutils.world.structure.structures;
...
public class examplestructureStructure extends Structure<NoFeatureConfig> {
    public examplestructureStructure() {
        super(NoFeatureConfig.CODEC);
    }

    public examplestructureStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return examplestructureStructure.Start::new;
    }
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator,
            ...
            JigsawManager.func_242837_a(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(NicodesUtils.MOD_ID, "examplestructure/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "ExampleStructure at " +
